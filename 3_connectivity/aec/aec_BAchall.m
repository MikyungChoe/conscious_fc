function aec_BAchall(cond,nfreq)

% sort all ch data BA*BA connectivity
% BAchlabel=subject, ch info
% BAchdata=aec value zBAchdata=fisher z(aec value)
...
% all subject info
list_f = dir(['E:\#ECoGconsciousness\Connect\sub*\aec\sub*_aecmin_rest.mat']);
% frequency
...
%% save file
cd(['E:\#ECoGconsciousness\Connect\all\aec\BAch'])
s1=['save -v7.3 BAchall_aec_' num2str(nfreq) fb{nfreq} '_' cond '.mat BAchlabel BAchdata zBAchdata lnBAchdata']; eval(s1);

fprintf(['...aec sort BA all ch data done....\n']);
